...
var ichars=rese;
    ...
    {
	alert ("@ symbol is must for re-type password");
		document.form1.repeatnewpassword.focus();
		return false;
    }
	else if(rese.length < 4)
	{alert("re-type password is too short ");
	document.form1.repeatnewpassword.focus();
	return false;
	}
	
	else if(rese.length > 15)
	{alert("re-type password is too long");
	document.form1.repeatnewpassword.focus();
	return false;
	}
}
...
<br>
<form action='changepassword5.php' method='post' name="form1" onSubmit="return validation1()">
